...
import com.example.weatherapi.security.BearerTokenServerAuthConverter;
...
public class WebSecurityConfig {
    ...
    private AuthenticationWebFilter bearerAuthenticationFilter(AuthenticationManager authenticationManager) {
        ...
        bearerAuthenticationFilter.setServerAuthenticationConverter(new BearerTokenServerAuthConverter(new JwtHandler(secret)));
