...
public class PBFDK2Encoder implements PasswordEncoder {
    ...
    private String secret; //кодируем на основании
    @Value("${jwt.password.encoder.iteration}")
    private Integer iteration; //колво итераций энкодинга
    ...
    @Override
    public String encode(CharSequence rawPassword) { //кодирует открытый пароль в шифр
    ...
    @Override
    public boolean matches(CharSequence rawPassword, String encodedPassword) { //принимает открытый пароль и шифр и сравнивает
